...
Сценарий: Я создаю номенклатуру "ТекИмя"
	...
	* Создание номенклатуры
		...
		И из выпадающего списка с именем 'ВидТовара' я выбираю точное значение "Товар"
	...
	* Проверка заполнения
		...
		И элемент формы с именем 'ВидТовара' стал равен "Товар"
...
Сценарий: Я создаю контрагента "ТекИмя", ИНН = "[ИНН]" 
	...
	* Проверка заполнения
		Тогда открылось окно "Контрагенты"
		И в таблице 'Список' я выбираю текущую строку
		И элемент формы с именем 'ИНН' стал равен "[ИНН]"
		И элемент формы с именем 'Наименование' стал равен "[ТекИмя]"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "[ТекИмя] (Контрагенты)" в течение 20 секунд
		Когда открылось окно "Контрагенты"
