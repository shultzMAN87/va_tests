...
Сценарий: 01. Ввод поступления товара
	...
	* Проверка движения
		* Хозрасчетный
			...
			Тогда таблица 'Список' стала равной по шаблону:
				...
				| 'Основной Агрыз' | '1' | ''             | 'ДНС Ритейл' | 'Поступление товаров услуг * от *' | 'Кол:'                  | '41.01'   | ''          | 'Оприходование товара на склад'     | ''                  | ''          | 'ВА - номенклатура мя' | ''              | '150,000'       | ''          | '<...>'        | ''                  | '60.01'   | ''          | 'ВА - поставщик' | '* от *' 			  | '1 500,00' |
		...
		* Остатки
			...
			Когда открылось окно "Поступление товаров услуг * от *"
			И Я закрываю окно "Поступление товаров услуг * от *"
			Тогда открылось окно "Поступление товаров услуг"
			И Я закрываю окно "Поступление товаров услуг"
						
Сценарий: 02. Закрытие клиента тестирвания
